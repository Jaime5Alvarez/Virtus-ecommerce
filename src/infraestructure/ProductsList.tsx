...
export const ProductsList = () => {
  ...
  return (
    <>
      <section className="bg-slate-400 bg-gradient-to-l dark:from-slate-700 dark:to-slate-600  rounded-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
